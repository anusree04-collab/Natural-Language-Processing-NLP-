TEXT SUMMARIZATION USING SPACY (MINI PROJECCT): 
     ...
     This project demonstrates Generic Extractive Text Summarization Using the Spacy NLP library . 
	 It explains how raw text is processed and summarized by selecting the most important sentences based on word frequency.
