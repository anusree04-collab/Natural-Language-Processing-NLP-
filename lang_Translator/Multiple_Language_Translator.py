...
df = pd.read_csv(r"C:\Users\K anusree\OneDrive\Desktop\FSDS\NLP\MULTIPLE LANGUAGE TRANSLATION\language.csv")
df.dropna(inplace=True)
lang = df['name'].to_list()
langlist=tuple(lang)
langcode = df['iso'].to_list()

#Create dictionary of languages and 2 letter langcode
...
#function to decode audio file to download
